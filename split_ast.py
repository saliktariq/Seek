...
if __name__ == "__main__":
    # app.py splits
    extract_nodes("app.py", ["AppState"], "seek/models/state.py", "import enum\n")
    extract_nodes(
        "app.py", ["APP_TITLE", "COLORS", "FONTS", "PADDINGS"], "seek/ui/theme.py", ""
    )
    extract_nodes(
        "app.py",
