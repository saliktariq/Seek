...
"""
engine_code += extract_block(dl_code, r"^(class DownloadEvent.*?)(?=\n_DURATION_TOLERANCE_MIN_S)") + "\n"
engine_code += extract_block(dl_code, r"^(_DURATION_TOLERANCE_MIN_S =.*?)(?=\ndef build_ydl_options)") + "\n"
engine_code += extract_block(dl_code, r"^(def build_ydl_options.*?\n)(?=if __name__ == )")
